...
export const metadata: Metadata = {
  title: "Carte Grise Orléans en Ligne - CPI WW | Changement Carte Grise & Immatriculation Temporaire Loiret | Service Agréé SIV",
  description: "Service carte grise professionnel à Orléans et dans le Loiret. Changement carte grise, duplicata, première immatriculation, carte grise temporaire. Traitement rapide 24-48h en Centre-Val de Loire. Bureau agréé SIV.",
  keywords: [
    "carte grise Orléans",
    "changement carte grise Orléans",
    "duplicata carte grise Orléans",
    "première immatriculation Orléans",
    "carte grise temporaire Orléans",
    "immatriculation Orléans",
    "Loiret",
    "Centre-Val de Loire",
    "CPI WW Orléans",
  ],
...
const jsonLd = {
  ...
  "@type": "LocalBusiness",
  "name": "CPI WW - Service Carte Grise Orléans",
  "description": "Service de carte grise et immatriculation provisoire CPI WW à Orléans et dans le Loiret.",
  "url": "https://www.cpi-ww.fr/carte-grise-orleans",
  "address": {
    "@type": "PostalAddress",
...
export default function CarteGriseOrleansPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
          ...
          <div className="container mx-auto px-4 pt-24 pb-12">
            <div className="text-center max-w-4xl mx-auto space-y-6">
              <Badge variant="secondary" className="mb-4 text-lg py-1 px-4 border-primary/20 bg-primary/5 text-primary">
                Service Agréé SIV - Préfecture du Loiret
              </Badge>
              <h1 className="text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-green-600 pb-2">
                Votre Carte Grise à Orléans
                <span className="block text-2xl md:text-3xl text-gray-600 mt-4 font-normal">
                  Simple, Rapide et 100% en Ligne
                </span>
              </h1>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Obtenez votre certificat d'immatriculation sans vous déplacer en préfecture d'Orléans. 
                Service habilité par le Ministère de l'Intérieur pour tous les véhicules dans le Loiret (45).
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl font-bold text-gray-900">
                  Service Carte Grise dans le Loiret (45)
                </h2>
                <p className="text-lg text-gray-600">
                  Habitant d'Orléans ou de sa région, ne perdez plus votre temps en démarches administratives complexes. 
                  Notre service en ligne vous permet de régulariser la situation de votre véhicule en quelques clics, 
                  que vous soyez à Orléans, Fleury-les-Aubrais, Olivet ou ailleurs dans le département.
                </p>
        ...
        <AnimatedSection className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-12">Zones d'Intervention près d'Orléans</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {["Fleury-les-Aubrais", "Olivet", "Saint-Jean-de-Braye", "Saint-Jean-de-la-Ruelle", "Saran", "Montargis", "Gien", "Pithiviers"].map((city) => (
