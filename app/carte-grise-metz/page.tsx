...
export const metadata: Metadata = {
  title:
    "Carte Grise Metz en Ligne - CPI WW | Changement Carte Grise & Immatriculation Temporaire Moselle | Service Agréé SIV",
  description:
    "Service carte grise professionnel à Metz et en ligne. Changement carte grise, duplicata, première immatriculation, carte grise temporaire. Traitement rapide 24-48h en Moselle. Bureau agréé SIV.",
  keywords: [
    "carte grise Metz",
    "changement carte grise Metz",
    "duplicata carte grise Metz",
    "première immatriculation Metz",
    "carte grise temporaire Metz",
    "immatriculation Metz",
    "Moselle",
    "CPI WW Metz",
  ],
  openGraph: {
    title: "Carte Grise Metz - Service Professionnel",
    description:
      "Carte grise à Metz et en Moselle. Démarches rapides et sécurisées : changement, duplicata, première immatriculation.",
    url: "https://cpi-ww.fr/carte-grise-metz",
    siteName: "Carte Grise Metz",
    locale: "fr_FR",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Carte Grise Metz",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Carte Grise Metz - Démarches rapides",
    description: "Service carte grise à Metz. Changement, duplicata, première immatriculation.",
  },
  alternates: {
    canonical: "https://www.bureau-immatriculation.fr/carte-grise-metz",
  },
}
...
const jsonLd = {
  ...
  "@type": "LocalBusiness",
  name: "Carte Grise Metz",
  description:
    "Service professionnel de carte grise à Metz. Changement titulaire, duplicata, première immatriculation, carte grise temporaire.",
  url: "https://www.bureau-immatriculation.fr/carte-grise-metz",
...
export default function CarteGriseMetzPage() {
  return (
    <>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Démarches carte grise à Metz et en Moselle. Changement de titulaire, duplicata, première immatriculation et carte grise temporaire avec un traitement rapide en 24-48h.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Phone className="h-6 w-6 text-green-600" /> Contact Metz
                  </CardTitle>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Professionnels carte grise à Metz</CardDescription>
                </CardHeader>
                <CardContent>
