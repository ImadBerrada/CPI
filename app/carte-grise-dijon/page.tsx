...
export const metadata: Metadata = {
  title: "Carte Grise Dijon en Ligne - CPI WW | Changement Carte Grise & Immatriculation Temporaire Côte-d'Or | Service Agréé SIV",
  description: "Service carte grise professionnel à Dijon et en Côte-d'Or. Changement carte grise, duplicata, première immatriculation, carte grise temporaire. Traitement rapide 24-48h en Bourgogne-Franche-Comté. Bureau agréé SIV.",
  keywords: [
    "carte grise Dijon",
    "changement carte grise Dijon",
    "duplicata carte grise Dijon",
    "première immatriculation Dijon",
    "carte grise temporaire Dijon",
    "immatriculation Dijon",
    "Côte-d'Or",
...
const jsonLd = {
  ...
  "@type": "LocalBusiness",
  "name": "CPI WW - Service Carte Grise Dijon",
  "description": "Service de carte grise et immatriculation provisoire CPI WW à Dijon et en Côte-d'Or.",
  "url": "https://www.cpi-ww.fr/carte-grise-dijon",
  "address": {
    "@type": "PostalAddress",
...
export default function CarteGriseDijonPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
          ...
          <div className="container mx-auto px-4 pt-24 pb-12">
            <div className="text-center max-w-4xl mx-auto space-y-6">
              <Badge variant="secondary" className="mb-4 text-lg py-1 px-4 border-primary/20 bg-primary/5 text-primary">
                Service Agréé SIV - Préfecture de Côte-d'Or
              </Badge>
              <h1 className="text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-green-600 pb-2">
                Votre Carte Grise à Dijon
                <span className="block text-2xl md:text-3xl text-gray-600 mt-4 font-normal">
                  Simple, Rapide et 100% en Ligne
                </span>
              </h1>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Obtenez votre certificat d'immatriculation sans vous déplacer en préfecture de Dijon. 
                Service habilité par le Ministère de l'Intérieur pour tous les véhicules en Côte-d'Or (21).
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl font-bold text-gray-900">
                  Service Carte Grise en Côte-d'Or (21)
                </h2>
                <p className="text-lg text-gray-600">
                  Habitant de Dijon ou de sa région, ne perdez plus votre temps en démarches administratives complexes. 
                  Notre service en ligne vous permet de régulariser la situation de votre véhicule en quelques clics, 
                  que vous soyez à Dijon, Beaune, Chenôve ou ailleurs dans le département.
                </p>
        ...
        <AnimatedSection className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-12">Zones d'Intervention près de Dijon</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {["Beaune", "Chenôve", "Talant", "Chevigny-Saint-Sauveur", "Quetigny", "Longvic", "Fontaine-lès-Dijon", "Auxonne"].map((city) => (
