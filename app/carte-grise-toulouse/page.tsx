...
export const metadata: Metadata = {
  title: "Carte Grise Toulouse en Ligne - CPI WW | Changement Carte Grise & Immatriculation Temporaire Haute-Garonne | Service Agréé SIV",
  description: "Service carte grise professionnel à Toulouse et en Haute-Garonne. Changement carte grise, duplicata, première immatriculation, carte grise temporaire. Traitement rapide 24-48h en Occitanie. Bureau agréé SIV.",
  keywords: [
    "carte grise Toulouse",
    "changement carte grise Toulouse",
    "duplicata carte grise Toulouse",
    "première immatriculation Toulouse",
    "carte grise temporaire Toulouse",
    "immatriculation Toulouse",
    "Haute-Garonne",
    "Occitanie",
    "CPI WW Toulouse",
  ],
...
const jsonLd = {
  ...
  "@type": "LocalBusiness",
  "name": "CPI WW - Service Carte Grise Toulouse",
  "description": "Service de carte grise et immatriculation provisoire CPI WW à Toulouse et en Haute-Garonne.",
  "url": "https://www.cpi-ww.fr/carte-grise-toulouse",
  "address": {
    "@type": "PostalAddress",
...
export default function CarteGriseToulousePage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
          ...
          <div className="container mx-auto px-4 pt-24 pb-12">
            <div className="text-center max-w-4xl mx-auto space-y-6">
              <Badge variant="secondary" className="mb-4 text-lg py-1 px-4 border-primary/20 bg-primary/5 text-primary">
                Service Agréé SIV - Préfecture de Haute-Garonne
              </Badge>
              <h1 className="text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-green-600 pb-2">
                Votre Carte Grise à Toulouse
                <span className="block text-2xl md:text-3xl text-gray-600 mt-4 font-normal">
                  Simple, Rapide et 100% en Ligne
                </span>
              </h1>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Obtenez votre certificat d'immatriculation sans vous déplacer en préfecture de Toulouse. 
                Service habilité par le Ministère de l'Intérieur pour tous les véhicules en Haute-Garonne (31).
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl font-bold text-gray-900">
                  Service Carte Grise en Haute-Garonne (31)
                </h2>
                <p className="text-lg text-gray-600">
                  Habitant de Toulouse ou de sa région, ne perdez plus votre temps en démarches administratives complexes. 
                  Notre service en ligne vous permet de régulariser la situation de votre véhicule en quelques clics, 
                  que vous soyez à Toulouse, Colomiers, Tournefeuille ou ailleurs dans le département.
                </p>
        ...
        <AnimatedSection className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-12">Zones d'Intervention près de Toulouse</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {["Colomiers", "Tournefeuille", "Blagnac", "Muret", "Cugnaux", "Plaisance-du-Touch", "Balma", "Ramonville-Saint-Agne"].map((city) => (
