...
export const metadata: Metadata = {
  title: "Carte Grise Besançon en Ligne - CPI WW | Changement Carte Grise & Immatriculation Temporaire Doubs | Service Agréé SIV",
  description: "Service carte grise professionnel à Besançon et dans le Doubs. Changement carte grise, duplicata, première immatriculation, carte grise temporaire. Traitement rapide 24-48h en Bourgogne-Franche-Comté. Bureau agréé SIV.",
  keywords: [
    "carte grise Besançon",
    "changement carte grise Besançon",
    "duplicata carte grise Besançon",
    "première immatriculation Besançon",
    "carte grise temporaire Besançon",
    "immatriculation Besançon",
    "Doubs",
...
const jsonLd = {
  ...
  "@type": "LocalBusiness",
  "name": "CPI WW - Service Carte Grise Besançon",
  "description": "Service de carte grise et immatriculation provisoire CPI WW à Besançon et dans le Doubs.",
  "url": "https://www.cpi-ww.fr/carte-grise-besancon",
  "address": {
    "@type": "PostalAddress",
...
export default function CarteGriseBesanconPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
          ...
          <div className="container mx-auto px-4 pt-24 pb-12">
            <div className="text-center max-w-4xl mx-auto space-y-6">
              <Badge variant="secondary" className="mb-4 text-lg py-1 px-4 border-primary/20 bg-primary/5 text-primary">
                Service Agréé SIV - Préfecture du Doubs
              </Badge>
              <h1 className="text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-green-600 pb-2">
                Votre Carte Grise à Besançon
                <span className="block text-2xl md:text-3xl text-gray-600 mt-4 font-normal">
                  Simple, Rapide et 100% en Ligne
                </span>
              </h1>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Obtenez votre certificat d'immatriculation sans vous déplacer en préfecture de Besançon. 
                Service habilité par le Ministère de l'Intérieur pour tous les véhicules dans le Doubs (25).
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl font-bold text-gray-900">
                  Service Carte Grise dans le Doubs (25)
                </h2>
                <p className="text-lg text-gray-600">
                  Habitant de Besançon ou de sa région, ne perdez plus votre temps en démarches administratives complexes. 
                  Notre service en ligne vous permet de régulariser la situation de votre véhicule en quelques clics, 
                  que vous soyez à Besançon, Montbéliard, Pontarlier ou ailleurs dans le département.
                </p>
        ...
        <AnimatedSection className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-12">Zones d'Intervention près de Besançon</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {["Montbéliard", "Pontarlier", "Audincourt", "Valentigney", "Morteau", "Seloncourt", "Bethoncourt", "Grand-Charmont"].map((city) => (
